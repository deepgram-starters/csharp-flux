...
C# (.NET) demo app for Deepgram Flux.
...
```
feat(csharp-flux): add diarization support
fix(csharp-flux): resolve WebSocket close handling
refactor(csharp-flux): simplify session endpoint
